...
import com.smallcloud.refact.modes.diff.dialog.filter
import com.smallcloud.refact.panes.gptchat.ChatGPTPaneInvokeAction
...
class QuickLongthinkActionsService {
    ...
    init {
        for (groupName in listOf("EditorPopupMenu")) {
            ...
            groups.add(group)
            actions.forEach {
                group.addAction(it, Constraints(Anchor.FIRST, "CodifyAskChat"))
            }
        }
    }
