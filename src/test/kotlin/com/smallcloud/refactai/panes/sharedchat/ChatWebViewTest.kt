...
class ChatWebViewTest: LightPlatform4TestCase() {
    private lateinit var testableEditor: TestableEditor


    override fun setUp() {
        super.setUp()
        testableEditor = TestableEditor(project)
    }
    
    @Test
    fun testBrowserInitializationRaceCondition() {
        // Create a ChatWebView instance with the testable editor
        val chatWebView = TestableChatWebView(testableEditor) { /* message handler */ }
